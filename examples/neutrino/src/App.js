...
const App = () => (
  <Navbar leftItems={leftItems} rightItems={rightItems}>
    <Segment>
      <Header as='h1'>Your sample App</Header>
      ...
      <Grid>
        ...
        <Grid.Column computer={10} mobile={16}>
          ...
          <CustomMessage>
            <p>Hey, it is a custom message!</p>
          </CustomMessage>
          ...
          <List bulleted>
            <List.Item>
              we premade <code>~styling/theming.less</code> for you, when you will include it in
              your LESS file you will able to use your existing SUI variables!
            </List.Item>
            <List.Item>
              we enabled{' '}
              <a
